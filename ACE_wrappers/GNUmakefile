...
C++NPv1_Reactive_Logging_Server_Ex: ACE
...
C++NPv1_Iterative_Logging_Server: ACE C++NPv1_Reactive_Logging_Server_Ex
...
Bug_3102_Regression_Test: ACE Test_Output Hash_Map_Bucket_Iterator_Test
	$(KEEP_GOING)@cd tests && $(MAKE) -f GNUmakefile.Bug_3102_Regression_Test all

.PHONY: Bug_3319_Regression_Test
Bug_3319_Regression_Test: ACE Test_Output Hash_Map_Bucket_Iterator_Test
	$(KEEP_GOING)@cd tests && $(MAKE) -f GNUmakefile.Bug_3319_Regression_Test all

.PHONY: Bug_3332_Regression_Test
Bug_3332_Regression_Test: ACE Test_Output Hash_Map_Bucket_Iterator_Test
